...
impl ShaderManager for WaveSchrodingerSimulation {
    fn init(core: &Core) -> Self {
        ...
        let unprocessed_shader = std::fs::read_to_string("shaders/wave_schrodinger.wgsl")
        ...
        std::fs::write("shaders/wave_schrodinger_generated.wgsl", shader)
            .expect("Unable to write shader");

        let compute_shader =
            create_compute_shader(core, config, params, "wave_schrodinger_generated");
